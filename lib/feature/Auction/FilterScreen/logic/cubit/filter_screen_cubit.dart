...
import 'package:thi/feature/Auction/FilterScreen/data/postUpComing.dart';
    ...
    DioHelper.postData("upcoming1",
      ...
      for (var i = 0; i < postUpcomingActions!.auctions!.length; i++) {
        CachShpreafapp.getdata(
                key:
                    "boolfavoratieActions${CachShpreafapp.getdata(key: "UserID")}${postUpcomingActions!.auctions![i].horses!.auctionId}") ??
