...
import 'package:thi/feature/Reservations/Booking/data/CoursBooking.dart';
import 'package:thi/feature/Reservations/Booking/data/DatailsClassmodel.dart';
import 'package:thi/feature/Reservations/Booking/data/getCoursdata.dart';
...
// await pusher.trigger(onEvent: onEvent1);
  ...
  void configurePusher12(
      {required int club_ID,
      required int service_id,
      required int trainer_id}) async {
    PusherChannelsFlutter pusher = PusherChannelsFlutter.getInstance();
    // pusher.connectionState.
    try {
      // app_id = "1793069" key = "e5d6ede1b86a447371cc" secret = "46834166895d119dc392" cluster = "eu"
      ...
      print(
          "CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC((((((((((((((((((((99999999999999999999))))))))))))))))))))");
      await pusher.init(
        apiKey: "e5d6ede1b86a447371cc",
        cluster: "eu",
        useTLS: true,
  ...
  Function onEvent1122(
    ...
    return (dynamic event) {
      ...
      postCoursDataAddBookingModel(
          club_ID: club_ID, service_id: service_id, trainer_id: trainer_id);
      // قم بتنفيذ العمليات المطلوبة هنا باستخدام event و id
      // print(
      //     'Received event in customEventHandler with id: $idCours - ${event.toString()}');
    };
